...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-exf0qmi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-exf0qmi.containers.anotherwebservice.com/
...
```
git clone git@github.com:DimitriViel/container-exf0qmi.git
cd container-exf0qmi
```
...
```
docker attach container-exf0qmi
```
